...
class Game {
    ...
    initialisePlayers() {
        ...
        player1.moveTo( this.windowWidth / 2 - player1.paddleWidth - this.playerXPosOffset, this.windowHeight / 2 - (player1.paddleHeight / 2))
        player2.moveTo(this.windowWidth / 2 + this.playerXPosOffset, this.windowHeight / 2 - (player2.paddleHeight / 2))
    ...
    moveGameObjects(frame: number) {
        ...
        this.ball.move(this.windowWidth, this.windowHeight, [this.players[0].paddle, this.players[1].paddle])
    }
